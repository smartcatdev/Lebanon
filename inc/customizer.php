...
function lebanon_customize_register( $wp_customize ) {
    ...
    class LebanonCustomizerPanel extends WP_Customize_Control {
        ...
        public function render_content() { ?>
            ...
            <p>
                <?php _e( 'You can select if you want your homepage to show the Blog or the Frontpage from <b> Frontpage -> Static Front Page</b>', 'lebanon' ); ?>
            </p>
            <h4>
                <?php _e( 'Enjoy this free theme! If you have any recommendations, comments or suggestions please leave us a comment on our', 'lebanon' ); ?>
                <a href="https://www.facebook.com/SmartcatDesign/" target="_BLANK"><?php _e( 'Facebook page', 'lebanon' ); ?></a>
            </h4>
        <?php }
    ...
    require_once trailingslashit( get_template_directory() ) . 'inc/customizer-panels/jumbotron.php';
...
function lebanon_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
